...
import CryptocurrencyCard from "./components/CardCryptoInstance.jsx";
...
const App = () => {
  ...
  const fetchCurrencies = () => {
    axios.get('http://127.0.0.1:8000/currencies/list/').then(r => {
  ...
  return (
    <div className="flex ">
      ...
      <div className="mx-auto my-auto">
        {currencyData ? <CryptocurrencyCard currency={currencyData}/> : <Spin size="small"/>}
      </div>
    </div>
  );
};
